        ...
        <div>
            <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                ...
                <ul className="nav col-md-4 justify-content-end list-unstyled d-flex social-bar">
                    <a href="https://www.linkedin.com/in/vinay-singh-thapa" target="_blank"  rel="noreferrer" ><i className="fa fa-linkedin"></i></a>
                    <a href="https://www.instagram.com/thapa._.vinay" target="_blank"  rel="noreferrer" ><i className="fa fa-instagram"></i></a>
