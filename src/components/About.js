...
export default function About() {
    return (
        <div className='container ' style={{ marginTop: "290px", marginBottom: "200px", textAlign: "center" }}>
            ...
            <div className='container' style = {{marginTop : "10px" }}>
                <ul className="nav col-md-4 justify-content-center list-unstyled d-flex " style = {{ margin : "auto"}}>
                    <a href="https://www.linkedin.com/in/vinay-singh-thapa" target="_blank" rel="noreferrer" style = {{color: 'black',fontSize: '50px',padding: '20px'}}><i className="fa fa-linkedin"></i></a>
                    <a href="https://www.instagram.com/thapa._.vinay" target="_blank" rel="noreferrer" style = {{color: 'black',fontSize: '50px',padding: '20px'}} ><i className="fa fa-instagram"></i></a>
